...
%Check for existence of file/folder and tag on appendage if necessary
tempname = NAME;
if exist(full_file_str,'file') == 2 % input is a file
    ...
    a = a+1;
    change_detect = true;
elseif exist(full_file_str,'file') == 7 % input is a folder
    appendage_str = strrep(appendage_str, num2str(z), num2str(a));
    tempNAME = [NAME, appendage_str];
    full_file_str = fullfile(PATHSTR, tempNAME);
    z = a;
    a = a+1;
    change_detect = true;
end
