...
params.numVals          = 3;        % number of validation trials
params.Ts               = 0.083;     % sampling period
params.K                = 12*300*15;     % numer of snapshotPairs to take
...
params.systemName          = 'larmv4_3val300s_16sid-clean_sc09_54000pts_1del_Ts083';  % name of current system
...
params.t        = 1e3 * params.N; % penalty on model complexity
