function [ fakeData , unique_fname ] = gen_fakeData_linLoad( sysName, sysvf, sysinput, params )
...
uq = interp1(t,u,tq);
wq = ones(size(tq)) * params.load;    % save the load at each timestep, only works for a single load
