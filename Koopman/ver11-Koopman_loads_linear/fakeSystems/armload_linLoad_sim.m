% armload_linLoad_sim.m
%   Main script for simulating a 1dof arm with load attached system, where
%   the load is not part of the state, but a linear disturbance term.

%% set double pendulum parameters
params = struct;

% system parameters
params.name = 'armload_linLoad_100s_load9';
...
params.D = -10;
params.g = 9.81;
params.load = 9;    % LOAD ATTACHED TO END EFFECTOR
...
data = gen_fakeData_linLoad( params.name, @armload_linLoad_vf, @armload_input, params );
