function animateModule_MWRW( t, y, ydes, u, params )
% animateModule.m
...
% global variable to save error at each time step
global nerror;
global k;
global nt;
k = 1;
...
for i = 1:length(tq)
    ...
    % do animation
    clf
    drawModule_MWRW(yq(i,1:3)', ydesq(i,:)', params, tq(i), uq(i,:));
