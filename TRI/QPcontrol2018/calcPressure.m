function [psol, exitflag] = calcPressure( error, params, fload)
%calcPressure: Calculates the input pressure needed to acheive a force 
...
[H, f, A, b, Aeq, beq] = quadCost(error, params, fload, params.penalty);
% A = zeros(num, num);
% b = zeros(num, 1);
% Aeq = zeros(num, num);
% beq = zeros(num, 1);
