...
% PID gains
Kp = eye(6);  % proportional gain
Ki = eye(6);  % integral gain
Kd = zeros(6,6);  % derivative gain
...
params.Kp = Kp;  % proportional gain
params.Ki = Ki;  % integral gain
params.Kd = Kd;  % derivative gain
