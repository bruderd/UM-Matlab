...
%     s = [x0; zeros(N*n,1); u0; zeros(N*m,1); zeros(N*n,1)];  % intial decision variable s (includes x, u, and dxdt for all time steps). Initialized to all ones other than initial values
