...
params.x0 = [2 1 pi/2]';    %state vector initial condition
params.u0 = [0 0]';        %input vector initial condition
...
s_star = fmincon(@(s)obj(s, params), s0, [], [],[],[], lb, ub, @(s)Dynamics(s,params), options);
