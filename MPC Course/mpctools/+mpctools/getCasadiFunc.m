...
% * `rk4`: Logical
%
%   > True or false to whether the function should be discretized with an
%   explicit RK4 method. Note that the first argument is assumed to be the
%   state.
%
% * `Delta`: Scalar
%
...
%   use. In general 'SX' should be used for primitive algebraic operations
