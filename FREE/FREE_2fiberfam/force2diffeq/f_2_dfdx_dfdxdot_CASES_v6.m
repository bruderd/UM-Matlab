...
f_case1 = [-dP + 0.5*(u - P);...
        ...
        P*dr - sin(gama)*dT_gama - sin(betta)*dT_betta + r*dP - cos(betta)*T_betta*dbetta - cos(gama)*T_gama*dgama];
...
f_case2 = [-dP + 0.5*(u - P);...
        ...
        (tan(gama)*L*dr)/r^2 - (tan(gama)*dL)/r - (L*(tan(gama)^2 + 1)*dgama)/r - dphi;...
        (tan(betta)*L*dr)/r^2 - (tan(betta)*dL)/r - (L*(tan(betta)^2 + 1)*dbetta)/r - dphi;...
        sin(betta)*dT_betta + sin(gama)*dT_gama + P*dr + r*dP + cos(betta)*T_betta*dbetta + cos(gama)*T_gama*dgama];
...
f_case4 = [-dP + 0.5*(u - P);...
        ...
        (tan(gama)*L*dr)/r^2 - (tan(gama)*dL)/r - (L*(tan(gama)^2 + 1)*dgama)/r - dphi;...
        (tan(betta)*L*dr)/r^2 - (tan(betta)*dL)/r - (L*(tan(betta)^2 + 1)*dbetta)/r - dphi;...
        sin(gama)*dT_gama - sin(betta)*dT_betta + P*dr + r*dP - cos(betta)*T_betta*dbetta + cos(gama)*T_gama*dgama];
