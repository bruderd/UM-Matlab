...
% virtual work constraint PdV = FdL + Mdphi
virtualwork = P*pi*(L*r^2 - L_prev*r_prev^2) - (P*pi*r^2 - 2*(T_gama*cos(gama) + T_betta*cos(betta)))*(L - L_prev) - 2*r*(T_gama*sin(gama) + T_betta*sin(betta))*(phi - phi_prev);
