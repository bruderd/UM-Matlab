...
% params.Felast_consts = [10, 0, 0];     % force elastomer constants (L0 = 5.68 in)
% params.Melast_consts = [10, 0, 0];     % moment elastomer constants (L0 = 5.68 in)
...
% params.Felast_consts = [0, 0.1, 0];     % force elastomer constants
