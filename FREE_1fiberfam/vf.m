function [f, dfdx, dfdu, df_ddxdt] = vf(x, u, dxdt, params)
 ...
 % -phi + (-tan(gama)*L/r + tan(gama0)*L0/r0)      this is the phi constraint
    ...
    dfdx = [-1*0.5,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      0,                                                                                                                                                                                                                                                                                                                                                                                                         0,                                                                                                                                                                                                                                                     0;...
            ...
            - 2*dgama*pi*(cot(gama)^2 + 1)*r^3 + 6*dr*pi*cot(gama)*r^2, c5*((dL*(tan(gama)^2 + 1))/r - (L*dr*(tan(gama)^2 + 1))/r^2 + (2*L*dgama*tan(gama)*(tan(gama)^2 + 1))/r) - 2*c4*((L*tan(gama))/r - (L0*tan(gama0))/r0)*((dL*(tan(gama)^2 + 1))/r - (L*dr*(tan(gama)^2 + 1))/r^2 + (2*L*dgama*tan(gama)*(tan(gama)^2 + 1))/r) - 2*pi*dP*r^3*(cot(gama)^2 + 1) - (2*L*c4*(tan(gama)^2 + 1)*((dL*tan(gama))/r + (L*dgama*(tan(gama)^2 + 1))/r - (L*dr*tan(gama))/r^2))/r - 6*pi*P*dr*r^2*(cot(gama)^2 + 1) + 4*pi*P*dgama*r^3*cot(gama)*(cot(gama)^2 + 1), 2*c4*((L*tan(gama))/r - (L0*tan(gama0))/r0)*((dL*tan(gama))/r^2 + (L*dgama*(tan(gama)^2 + 1))/r^2 - (2*L*dr*tan(gama))/r^3) - c5*((dL*tan(gama))/r^2 + (L*dgama*(tan(gama)^2 + 1))/r^2 - (2*L*dr*tan(gama))/r^3) + 6*pi*dP*r^2*cot(gama) + 12*pi*P*dr*r*cot(gama) - 6*pi*P*dgama*r^2*(cot(gama)^2 + 1) + (2*L*c4*tan(gama)*((dL*tan(gama))/r + (L*dgama*(tan(gama)^2 + 1))/r - (L*dr*tan(gama))/r^2))/r^2, c5*((dgama*(tan(gama)^2 + 1))/r - (dr*tan(gama))/r^2) - 2*c4*((dgama*(tan(gama)^2 + 1))/r - (dr*tan(gama))/r^2)*((L*tan(gama))/r - (L0*tan(gama0))/r0) - (2*c4*tan(gama)*((dL*tan(gama))/r + (L*dgama*(tan(gama)^2 + 1))/r - (L*dr*tan(gama))/r^2))/r;...
